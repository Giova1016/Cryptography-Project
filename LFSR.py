def lfsr(initial_state, polynomial_degree, cycles):
    ...
    Parameters:
    - initial_state (str): The initial state of the bits (binary representation).
    - polynomial_degree (int): The degree of the polynomial that indicates the position of the flip-flops.
    - cycles (int): The number of cycles to be performed in the LFSR.
